...
if (isset($_GET['cari'])) {
    ...
    $apparel = query("SELECT * FROM buku WHERE
    ...
    $apparel = query("SELECT * FROM buku");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>HALAMAN DEPAN | Toko</title>
</head>
                    ...
                    <?php foreach ($apparel as $apr) : ?>
                        <div class="col-sm-3 mb-3">
                            <div class="card mt-3 img-thumbnail">
                                <img class="card-img-top" src="assets/img/<?= $apr['Cover']; ?>" alt="card image cap">
                                <div class="card-body">
                                    <p class="card-text">
                                        <?= $apr['Judul']; ?>
                                        <hr><?= $apr['Pengarang']; ?>
